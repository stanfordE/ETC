...
uint256 hashGenesisBlock("0x00000701f965b612a57d1e9cf2f5c2f3055ec8b82f4e7b19f6b95ac89c4e13f8");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // EnteCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "EnteCoin Signed Message:\n";
...
{
    // EnteCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 0.06666667 * COIN;
	
	if (nHeight == 1)
		return 208900000 * COIN;

	// Stop at 210m total
	if (nHeight > 164999992)
		return nFees;
...
static const int64 nTargetSpacing = 0.3333 * 60;
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
	...
	static const int64	BlocksTargetSpacing			= 0.3333 * 60;
	unsigned int		TimeDaySeconds				= 60 * 60 * 24;
	int64				PastSecondsMin				= TimeDaySeconds * 0.3333 * 0.1;
	int64				PastSecondsMax				= TimeDaySeconds * 0.3333 * 2.8;
...
{
    // EnteCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "EnteCoin Genesis Block";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1461002137;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1391044;
        ...
        assert(block.hashMerkleRoot == uint256("0xee4108f07c6d32b0d2be9c9b74ead7ab5cb5556975286d733f970687f36002c2"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xd6, 0xb3, 0xd9 }; // EnteCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("EnteCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("EnteCoinMiner : ProcessBlock, block not accepted");
    }
